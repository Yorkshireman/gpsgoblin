        ...
        <Stack gap={{ base: 8, md: 10 }}>
          <Stack gap={4} align='flex-start'>
            ...
            <Text maxW='2xl' fontSize={{ base: 'lg', md: 'xl' }} color='fg.muted'>
              Open a GPX recording to inspect its route, track segments and calculated distance.
              Your activity file will be processed in your browser and will not be uploaded by this
              tool.
            </Text>
          </Stack>
