...
export const metadata = createPageMetadata('/', 'GPSGoblin — Free tools for GPS and activity files',
  'Explore your GPX routes, tracks and waypoints with GPSGoblin’s free GPX File Viewer. Your file stays on your device.');

const Home = () => {
  return (
    <Container as='main' maxW='5xl' px={{ base: 4, md: 6 }} py={{ base: 8, md: 16 }}>
      <Stack gap={5} align='start'>
        <Heading as='h1' size={{ base: '3xl', md: '4xl' }}>GPSGoblin</Heading>
        <Text fontSize='xl'>Free tools for GPS and activity files.</Text>
        <Text maxW='prose'>Explore a walk, ride, run or planned route. Your file stays on your device, with no account needed.</Text>
