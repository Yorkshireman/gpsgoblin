...
export const StopOptions = ({ mode, onModeChange, axis, onAxisChange, hasStops, timeAvailable }: StopOptionsProps) => {
  return <Grid templateColumns={hasStops ? 'repeat(2, minmax(0, 1fr))' : 'minmax(0, 1fr)'} gap={2} pt={2}>
    {hasStops ? <Field.Root>
